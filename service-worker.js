...
const RESOURCES_TO_CACHE = [
  ...
  "./imagens/plays/case-contando-estrelas.png",
  "./imagens/plays/case-leticia-vaz.png",
  "./imagens/plays/case-galileu-nogueira.png",
  "./imagens/plays/case-rafa-xavier.png",
  "./imagens/plays/case-micha-menezes.png",
  "./imagens/plays/case-gio-antonelli.jpeg",
  ...
  "./videos/CONTANDO-ESTRELAS.mp4",
  "./videos/HISTORIA-1-MICHA.mp4",
  "./videos/HISTORIA-2-GALILEU.mp4",
  "./videos/HISTORIA-3-RAFA.mp4",
  "./videos/HISTORIA-4-LETICIA.mp4",
  "./videos/HISTORIA-5-GIOVANA.mp4",
